 ...
 * Based on trading_platform-master/trading.html
 */
...
export function TradingTerminal({
  ...
  useEffect(() => {
    ...
    try {
      ...
      // Widget configuration matching trading_platform-master/trading.html
      const widgetConfig = {
        // Core settings
        fullscreen: true,
        symbol: symbol,
      ...
      console.log("[TradingTerminal] Creating widget...");
