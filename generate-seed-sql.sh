...
# Quick Market Data Seed Generator
# Generates SQL file that you can run in Supabase dashboard

echo "🚀 Generating Market Data SQL..."

cat > seed-market-data.sql << 'EOF'
...
echo "✅ SQL file generated: seed-market-data.sql"
echo ""
echo "📋 Next steps:"
echo ""
echo "1. Go to: https://supabase.com/dashboard/project/tevkmkadkgwgdutbjztu/editor"
echo "2. Click 'SQL Editor' in left menu"
echo "3. Click 'New Query'"
echo "4. Copy contents of: seed-market-data.sql"
echo "5. Paste and click 'Run'"
echo ""
echo "Expected output:"
echo "  Prices loaded: 23"
echo "  Daily candles loaded: 690"
echo "  Hourly candles loaded: 3887"
echo ""
echo "After running SQL:"
echo "  - Refresh your trading page"
echo "  - Charts should display!"
echo ""
